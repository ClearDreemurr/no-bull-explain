...
A teaching skill for AI coding agents (Claude Code, OpenAI Codex Copilot) that explains complex concepts with low cognitive load.
...
```
explain-complex-concepts/
├── SKILL.md              ← Core skill definition (main content)
├── README.md             ← This file
├── LICENSE               ← MIT License
├── agents/
